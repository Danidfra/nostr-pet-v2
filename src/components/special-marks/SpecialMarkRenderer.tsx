...
const SpecialMarkSVGs = {
    ...
    <svg viewBox="0 0 192 240" className="w-full h-full">
      <defs>
        <filter id="ring-glow" x="-50%" y="-50%" width="200%" height="200%">
          <feDropShadow dx="0" dy="0" stdDeviation="1" floodColor="rgba(130, 85, 30, 0.3)" floodOpacity="0.5" />
        </filter>
      </defs>
  ...
  glow_crack_pattern: (
    <svg viewBox="0 0 200 200" className="w-full h-full">
      ...
      <g stroke="#00ffe0" strokeWidth="2" fill="none" filter="url(#crack-glow)" strokeLinejoin="round">
...
import { isSpecialMarkSupported as isMarkSupported } from '@/lib/special-marks-utils';

// Re-export for convenience
export const isSpecialMarkSupported = isMarkSupported;
